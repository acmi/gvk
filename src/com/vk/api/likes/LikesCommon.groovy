...
class LikesCommon {
     ...
     */
    static Iterator<Like> getList(VKWorker worker, Type likeType, int ownerId, int itemId, int offset = 0, Filter filter = Filter.likes, boolean friendsOnly = false) {
     ...
     * @throws VKException
     */
    static Boolean isLiked(VKWorker worker, int userId, int ownerId, Type type, int itemId) throws IOException, VKException {
        use(DOMCategory) {
